...
import Barre from '../component/barrep';
      ...
      <main>
        <div className='container'>
          <div className='monoffre mb-4'>
            ...
            <p className='col-lg-12 col-md-6 col-sm-6 text-center'>Pour me contacter en vue d'un entretien ou d'une future collaboration, merci de remplir le formulaire de contact.</p>
            <div className="border-bottom border-5 border-bottom border-primary w-25 mb-3 p-1"></div>
          </div>
          <div className='bordure mb-5 p-3'>
            <div className='row '>

              <div className="col-sm-12 col-lg 6 ">

                <h3>Formulaire de contact</h3>
                <div className="border-bottom border-5 border-bottom border-primary w-100  "></div>
              ...
              <div className="col-sm-12 col-lg 6">
                ...
                <iframe className="w-100" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d22261.01720815189!2d4.778379534765626!3d45.77866200000001!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47f4eb65edac5b3f%3A0xe01c47049cb2e2b9!2s40%20Rue%20Laure%20Diebold%2C%2069009%20Lyon!5e0!3m2!1sfr!2sfr!4v1761584441798!5m2!1sfr!2sfr"
